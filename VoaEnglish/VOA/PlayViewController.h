...
@property (nonatomic, retain) IBOutlet UIButton        *toolBtn;
@property (nonatomic, retain) IBOutlet UIButton        *abBtn;
@property (nonatomic, retain) IBOutlet HSCButton        *aBtn;
@property (nonatomic, retain) IBOutlet HSCButton        *bBtn;
@property (nonatomic, retain) IBOutlet UISlider		*lightSlider;
...
@property (nonatomic, retain) UIMenuController	*speedMenu;
@property (nonatomic, retain) NSString	*selectWord;
@property (nonatomic) float	aValue;
@property (nonatomic) float	bValue;
@property (nonatomic) BOOL isSpeedMenu;
@property (nonatomic) BOOL isAbMenu;
@property (nonatomic) BOOL isResponse;
@property (nonatomic) BOOL isInforComm;
