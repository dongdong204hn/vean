...
//        engHight = [@"a" sizeWithFont:Courier].height;
        ...
        CGSize chSize = [[lyricCnArray objectAtIndex:i] sizeWithFont:CourierTwo constrainedToSize:CGSizeMake(textScroll.frame.size.width-15, CGFLOAT_MAX) lineBreakMode:UILineBreakModeWordWrap];
